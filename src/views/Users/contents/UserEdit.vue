    ...
    <card>
        <b-row align-v="center" slot="header" >
            ...
            <b-col cols="4" class="text-right">
                <a @click="emitListUserEvent" href="javascript:;" class="btn btn-sm btn-danger">Back</a>
                <a @click="emitListUserEvent" href="javascript:;" class="btn btn-sm btn-primary">Save</a>
            </b-col>
        </b-row>
...
<script>
    export default {
        ...
        data() {
            return {
                user: {
                    ...
                    username: 'LeChatong',
                    email: 'ulrich.tchatong@gmail.com',
                    firstName: 'Tchatong',
                    lastName: 'Ulrich',
                    address: 'Logbessou',
                    city: 'Douala',
        ...
        methods: {
            emitListUserEvent() {
                this.$emit('list-user-event', { typecontent: 'list' })
            }
        }
    }
</script>